...
import com.jeekite.online.dao.SysRolePermissionMapper;
...
public class SysRolePermissionServiceImpl implements SysRolePermissionService {
    ...
    public Example createExample(SysRolePermission sysRolePermission){
        ...
        if(sysRolePermission!=null){
            ...
            // 创建时间
            if(!StringUtils.isEmpty(sysRolePermission.getCreateTime())){
                    criteria.andEqualTo("createTime",sysRolePermission.getCreateTime());
            }
        }
        return example;
    }
