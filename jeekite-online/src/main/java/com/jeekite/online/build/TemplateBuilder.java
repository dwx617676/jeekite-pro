...
import com.jeekite.online.swagger.*;
import com.jeekite.online.util.*;
...
public class TemplateBuilder {
    ...
    static {
        try {
            //加载配置文件
            InputStream is = TemplateBuilder.class.getClassLoader().getResourceAsStream("application-dev.yml");
