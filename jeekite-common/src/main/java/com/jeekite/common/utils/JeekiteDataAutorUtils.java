package com.jeekite.common.utils;

import com.jeekite.common.result.SysUserCacheInfo;
...
/**
 * @ClassName: JeekiteDataAutorUtils
 * @Description: 数据权限查询规则容器工具类
 * @Author: 张代浩
 * @Date: 2020-06-03 下午11:27:39
 * 
 */
public class JeekiteDataAutorUtils {
